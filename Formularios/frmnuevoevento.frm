...
Begin VB.Form frmnuevoevento 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   315
         Index           =   1
         ItemData        =   "frmnuevoevento.frx":0CEA
         Left            =   840
         List            =   "frmnuevoevento.frx":0CEC
         TabIndex        =   7
         Text            =   "Combo1"
         Top             =   1050
         Width           =   1695
      ...
      Begin VB.ComboBox Combo1 
         ...
         Height          =   315
         Index           =   0
         ItemData        =   "frmnuevoevento.frx":0CEE
         Left            =   600
