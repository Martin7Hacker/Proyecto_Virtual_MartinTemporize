...
Begin VB.Form frmentradasalida 
   ...
   Begin VB.Frame frmRutina 
      ...
      Begin Virtual_Martin_temporize.ChameleonBtn cmdcomentario 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmentradasalida.frx":0CE6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin Virtual_Martin_temporize.ChameleonBtn cmdComentariox 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmentradasalida.frx":0D02
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   1470
         Left            =   0
         Picture         =   "frmentradasalida.frx":0D1E
         Top             =   0
         Width           =   2175
      End
   End
   Begin VB.Frame frmframe 
      ...
      Begin VB.Image Image2 
         Height          =   2295
         Left            =   120
         Picture         =   "frmentradasalida.frx":B7A8
         Top             =   240
         Width           =   3525
      End
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdcancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":25F46
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdfiltro 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmentradasalida.frx":25F62
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
