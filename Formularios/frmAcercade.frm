...
Begin VB.Form frmAcercade 
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdFacebook 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAcercade.frx":A7F4
      PICN            =   "frmAcercade.frx":A810
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdTwitter 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAcercade.frx":10002
      PICN            =   "frmAcercade.frx":1001E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Virtual_Martin_temporize.ChameleonBtn cmdyoutube 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmAcercade.frx":15810
      PICN            =   "frmAcercade.frx":1582C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
